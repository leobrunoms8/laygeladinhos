	...
	<head>
		...
		<script>
			function editar(id, txt_tarefa){
				...
				//criar input hidden para guardar id da tarefa
				...
				//selecionar a div tarefa correspondente
		...
		<div class="container app">
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						<li class="list-group-item active"><a href="#">Entregas pendentes</a></li>
